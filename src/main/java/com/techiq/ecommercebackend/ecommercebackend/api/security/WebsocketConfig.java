...
public class WebsocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void configureClientInboundChannel(ChannelRegistration registration) {
        ...
        registration.interceptors(jwtRequestFilter, authInterceptor, new RejectClientMessagesOnChannelChannelInterceptor(), new DestinationLevelAuthorizationChannelInterceptor());
    }

    private class RejectClientMessagesOnChannelChannelInterceptor implements ChannelInterceptor {
